  ...
  const copy = language === 'ar'
    ? {
        ...
        items: {
          ...
          financeStatements: 'كشوف الملاك',
          financePayouts: 'دفعات الملاك',
          financeVendorInvoices: 'فواتير الموردين',
    ...
    : {
        ...
        items: {
          ...
          financeStatements: 'Owner statements',
          financePayouts: 'Owner payouts',
          financeVendorInvoices: 'Vendor invoices',
