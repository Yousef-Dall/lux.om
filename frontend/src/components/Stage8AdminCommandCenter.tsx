...
return ( <section
 ...
 > <div> <p className="eyebrow">Operations command center</p> <h2 id="stage8-admin-title">Verification, safety, contracts, reviews, and transactions</h2> <p>
Monitor marketplace operations, review queues, and integration-ready workflows. Government, escrow, AI, and external verification services require approved provider access before activation. </p> </div>
