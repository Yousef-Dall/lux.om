...
export default function Stage8DashboardPanel({ token }: { token: string | null }) {
  ...
  return (
    <section className="stage8-operations-panel" aria-labelledby="stage8-dashboard-title">
      <div>
        <p className="eyebrow">Stage 8 workspace</p>
        <h2 id="stage8-dashboard-title">Saved items, contracts, payments, and transactions</h2>
        <p>
          Track your investor tools and transaction-readiness workflows from one dashboard. External alerts and official integrations remain dashboard-ready unless configured.
        </p>
      </div>
