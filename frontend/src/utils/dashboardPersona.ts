...
export type DashboardPersonaCapability = {
...
export type DashboardWorkspaceDefinition = {
...
export type DashboardPersonaDefinition = {
  ...
  capabilities: DashboardPersonaCapability;
  workspaces: DashboardWorkspaceDefinition[];
};

const sharedPersonalWorkspaces: DashboardWorkspaceDefinition[] = [
  {
    key: 'my-bookings',
...
const dashboardPersonaDefinitions: Record<DashboardPersona, DashboardPersonaDefinition> = {
  customer: {
    persona: 'customer',
...
export function getDashboardPersona(role?: UserRole | string | null): DashboardPersona {
...
export function getDashboardPersonaDefinition(role?: UserRole | string | null) {
  return dashboardPersonaDefinitions[getDashboardPersona(role)];
}

export function getDashboardPersonaCapabilities(role?: UserRole | string | null) {
  return getDashboardPersonaDefinition(role).capabilities;
}

export function getDashboardPersonaWorkspaces(role?: UserRole | string | null) {
  return getDashboardPersonaDefinition(role).workspaces;
}

export function getDashboardPersonaLabel(role?: UserRole | string | null, language: 'en' | 'ar' = 'en') {
  return getDashboardPersonaDefinition(role).label[language];
}

export function getDashboardPersonaDescription(
  role?: UserRole | string | null,
  language: 'en' | 'ar' = 'en'
) {
  return getDashboardPersonaDefinition(role).description[language];
}
