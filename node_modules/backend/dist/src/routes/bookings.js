...
exports.bookingsRouter.post('/', (0, auth_1.requireAuth)(), async (req, res, next) => {
    try {
        ...
        const listing = await prisma_1.prisma.listing.findUnique({ where: { id: data.listingId } });
...
exports.bookingsRouter.get('/admin/all', (0, auth_1.requireAuth)(), (0, auth_1.requireRole)('ADMIN'), async (_req, res, next) => {
    try {
