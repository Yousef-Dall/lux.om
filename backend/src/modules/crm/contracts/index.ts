...
export const crmContractVersion = '2026-07-11.stage21h' as const;
...
export const crmContactConsentStatuses = ['UNKNOWN', 'CONSENTED', 'LEGITIMATE_INTEREST', 'OPTED_OUT', 'BLOCKED', 'CANCELLED'] as const;
